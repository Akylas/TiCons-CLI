...
exports['ios-iTunesArtwork'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'iTunesArtwork'),
  size: 512,
  platforms: ['ios'],
  sdkVersion: '<5.0.0'
};
exports['ios-iTunesArtwork@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'iTunesArtwork@2x'),
  size: 1024,
  platforms: ['ios'],
  sdkVersion: '<5.0.0'
};
...
exports['ios-appicon'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon.png'),
  size: 57,
...
exports['ios-appicon@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon@2x.png'),
  size: 114,
  platforms: ['iphone'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-60.png'),
  size: 60,
  platforms: ['iphone'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-60@2x.png'),
  size: 120,
  platforms: ['iphone'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60@3x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-60@3x.png'),
  size: 180,
  platforms: ['iphone'],
  minVersion: 8,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-72'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-72.png'),
  size: 72,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-72@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-72@2x.png'),
  size: 144,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-76'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-76.png'),
  size: 76,
  platforms: ['ipad'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-76@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-76@2x.png'),
  size: 152,
  platforms: ['ipad'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small.png'),
  size: 29,
  platforms: ['iphone', 'ios'],
  sdkVersion: '<5.0.0'
};
exports['ios-appicon-Small@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small@2x.png'),
  size: 58,
  platforms: ['iphone', 'ios'],
  sdkVersion: '<5.0.0'
};
exports['ios-appicon-Small@3x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small@3x.png'),
  size: 87,
  platforms: ['iphone'],
  minVersion: 8,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-40'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small-40.png'),
  size: 40,
  platforms: ['ios'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-40@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small-40@2x.png'),
  size: 80,
  platforms: ['ios'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-50'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small-50.png'),
  size: 50,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-50@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-Small-50@2x.png'),
  size: 100,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-83.5@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'ios', 'appicon-83.5@2x.png'),
  size: 167,
  platforms: ['ipad'],
  minVersion: 9,
  sdkVersion: '<5.0.0'
...
exports['ios-Default-Portrait-2436h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'ios', 'Default-Portrait-2436h@3x.png'),
...
exports['ios-Default-Landscape-2436h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'ios', 'Default-Landscape-2436h@3x.png'),
